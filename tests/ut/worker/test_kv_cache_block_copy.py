...
def test_v2_model_runner_uses_ascend_block_copy():
    """The worker patch must rebind the v2 runner's imported reference."""
    import vllm_ascend.patch.worker.patch_v2.patch_worker_utils  # noqa: F401
    from vllm.v1.worker.gpu import model_runner as vllm_model_runner

    assert vllm_model_runner.copy_kv_cache_blocks_inplace is copy_kv_cache_blocks_inplace
